...
from backend.models.trip import GroupTripRequest, RecommendationDetails, ExpectationMatchResponse, Traveler
from backend.database.destinations import get_all_destinations
