...
from backend.models.trip import GroupTripRequest, RecommendationDetails
from backend.services.crew_service import run_travel_recommendation_crew
from backend.services.simulation import simulate_budget_adjustment
from backend.database.mock_db import list_destinations
from backend.services.recommendation_service import get_recommendations as get_recommendations_service
