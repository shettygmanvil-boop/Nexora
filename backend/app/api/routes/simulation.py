...
from app.agents.budget_agent.agent import get_budget_optimization_agent
from app.agents.budget_agent.tasks import get_budget_optimization_task
from app.agents.conflict_agent.conflict_agent import get_conflict_resolution_agent
from app.agents.conflict_agent.conflict_tasks import get_conflict_resolution_task
from app.agents.dynamic_sim_agent.agent import get_dynamic_simulation_agent
...
async def run_budget_simulation(payload: SimulationRequest):
    ...
    try:
        ...
        if not CREWAI_AVAILABLE:
            return {"status": "error", "detail": "CrewAI is not installed"}
